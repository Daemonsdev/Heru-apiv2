...
const createLogger = (colorFn, prefix = '') => 
    (text) => console.log(kleur.bold(colorFn(`[${getTime()}] [ Heru ]${prefix} » ${text}`)));
...
const createErrorLogger = (colorFn) => 
    (text) => console.log(kleur.bold(colorFn(`[${getTime()}] [ Heru ] [ Error ] » ${text}`)));

// Create warn logger with [ Warn ] prefix
const createWarnLogger = (colorFn) => 
    (text) => console.log(kleur.bold(colorFn(`[${getTime()}] [ Heru ] [ Warn ] » ${text}`)));
