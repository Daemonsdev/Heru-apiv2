...
exports.config = {
    ...
    category: 'canvas',
    link: ['/uptime?instag=JayMar&ghub=heru&fb=Jay Mar&hours=1&minutes=23&seconds=45&botname=herubot']
};
...
exports.initialize = async function ({ req, res }) {
    try {
        ...
        if (!instag || !ghub || !fb || !hours || !minutes || !seconds || !botname) {
            return res.status(400).json({ error: "usage: /uptime?instag=your_instagram_username&ghub=your_github_username&fb=your_facebook_username&hours=1&minutes=23&seconds=45&botname=your_bot_name" });
        }
        ...
        const backgroundUrl = 'https://imgur.com/xwCoQ5H.jpg';
