...
exports.config = {
    ...
    category: 'canvas',
    link: ['/welcome?username=Jay&avatarUrl=https://i.imgur.com/34LyOyS.jpeg&groupname=Test Bot&bg=https://i.ibb.co/4YBNyvP/images-76.jpg&memberCount=25'],
};
...
exports.initialize = async function ({ req, res }) {
    try {
        ...
        if (!username || !avatarUrl || !groupname || !memberCount) {
            return res.status(400).json({ error: "usage: /welcome?username=your_username&avatarUrl=your_avatar_url&groupname=your_group_name&memberCount=your_member_count " });
        }
